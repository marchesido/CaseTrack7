...
export class ProductionStageAssigneesDto {
  @ApiPropertyOptional({
    description: 'ID do responsável pela etapa de Captação',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'ID do responsável pela etapa de Edição',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'ID do responsável pela etapa de Backup',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'ID do responsável pela etapa de Upload',
  })
  @IsOptional()
...
export class CreateProductionDto {
  @ApiProperty({
    description: 'Título da produção audiovisual',
    example: 'Comercial Campanha de Verão',
  })
  ...
  @ApiProperty({
    description: 'Data/hora agendada de início (ISO 8601)',
    example: '2026-09-10T09:00:00.000Z',
  })
  @IsNotEmpty({ message: 'A data agendada de início é obrigatória' })
  @IsDateString(
    {},
    { message: 'scheduledAt deve ser uma data ISO 8601 válida' },
  )
  scheduledAt: string;

  @ApiPropertyOptional({
    description: 'Data/hora agendada de término (ISO 8601)',
    example: '2026-09-10T18:00:00.000Z',
  })
  @IsOptional()
  @IsDateString(
    {},
    { message: 'scheduledEndAt deve ser uma data ISO 8601 válida' },
  )
  scheduledEndAt?: string;

  @ApiPropertyOptional({
    description: 'Indica se a produção ocorre no dia inteiro',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Fuso horário da produção',
  ...
  @ApiPropertyOptional({
    description: 'Lista de IDs dos equipamentos necessários',
    type: [String],
  })
  @IsOptional()
  @IsArray()
  @IsUUID('4', {
    each: true,
    message: 'Cada equipamento deve ser um UUID válido',
  })
  equipmentIds?: string[];

  @ApiPropertyOptional({
    description: 'Responsáveis pelas etapas lineares',
